        ...
        for paper in taxa_dict[taxa]:
            ...
            #for year in data[paper[0]]:
                ...
                if year in citations_dict[taxa]:
                    ...
                    citations_dict[taxa][year] = 1
    return alive_dict, citations_dict

    
    
    
def plot_graphs(alive_dict, citations_dict, taxas, json):
    fig, ax = plt.subplots()
    ...
    axCites = plt.axes([0.25, 0.15, 0.65, 0.03])
    cites_slider = Slider(ax=axCites, label="Citations", valmin=1, valmax=10, valstep=1, color="red", valinit=3)            
...
if __name__ == "__main__":
    ...
    alive_dict, citations_dict = process_data(args.taxas, args.json)
    plot_graphs(alive_dict, citations_dict, args.taxas, args.json)